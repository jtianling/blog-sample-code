 ...
 *********************************************************************
  ...
  本工程是一个在Win32下利用OpenGL进行的最简单的矩形绘制程序。
  本工程用Visual Studio 2008 SP1管理工程。
	
  对应的博客文章是《Win32 OpenGL 编程（3）基本图元（点，直线，多边形）的绘制》
  http://blog.csdn.net/vagrxie/archive/2009/10/13/4663465.aspx

 *******************************************************************/
// *********************************************************************
//	文件信息：
//	创建日期:	09-10-12
//	文件名: 	SimpleRectangle.cpp
//	文件说明:	利用OpenGL进行的最简单的矩形绘制程序主文件
// *********************************************************************/
// INCLUDES ///////////////////////////////////////////////
